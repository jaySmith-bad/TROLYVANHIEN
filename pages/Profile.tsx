...
import { User, Cake, BookOpen, Building, Mail, CreditCard, Users, Binary, Clipboard, Thermometer, Sun, Cloud, CloudRain, Droplets, Wind } from 'lucide-react';
...
const Profile: React.FC = () => {
 ...
 const WeatherIcon = () => {
   switch(weather.condition) {
     case 'sunny': return <Sun className="w-24 h-24 text-accent-yellow" />;
     case 'cloudy': return <Cloud className="w-24 h-24 text-slate" />;
     case 'rainy': return <CloudRain className="w-24 h-24 text-accent-cyan" />;
     default: return null;
   }
 };
 ...
 return (
   <div className="space-y-8">
       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-1 flex flex-col items-center bg-navy p-8 rounded-lg">
           ...
           <div className="lg:col-span-2 bg-navy p-8 rounded-lg">
     ...
     <div className="bg-navy p-8 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
